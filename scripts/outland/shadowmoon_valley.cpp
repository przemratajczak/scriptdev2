...
void AddSC_shadowmoon_valley()
{
    ...
    newscript = new Script;
    newscript->Name = "npc_spawned_oronok_tornheart";
    newscript->GetAI = &GetAI_npc_spawned_oronok_tornheart;
    newscript->pGossipHello =  &GossipHello_npc_spawned_oronok_tornheart;
	...
	newscript = new Script;
    newscript =->Name = "npc_domesticated_felboar";
    newscript =->GetAI = &GetAI_npc_domesticated_felboar;
    newscript =->RegisterSelf();

    newscript = = new Script;
    newscript =->Name = "npc_shadowmoon_tuber_node";
    newscript =->pEffectDummyNPC = &EffectDummyCreature_npc_shadowmoon_tuber_node;
    newscript =->RegisterSelf();
}
